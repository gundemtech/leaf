...
| Термин | Значение |
|---|---|
| **LeafControl** | Публичное название продукта (macOS, далее iOS) |
| **Leaf** | Кодовая форма, в имени app-репо `gundemtech/leaf` |
...
| **Shared memory** | `.claude/shared/*.md` в LeafControl-репо — контекст, автоматически читаемый Claude Code у всей команды |
