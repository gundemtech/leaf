...
- `presence_state` — single-row-per-provider materialized view current presence ceiling (Phase 4.7.A M005). Read by MenuBarApp self-UI и Phase 5 broadcaster (encrypted snapshot). PK — `provider`. Writes — Track 4.7.B.
