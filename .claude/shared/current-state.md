...
2026-04-24 (Phase 1.2 Agent daemon + LaunchAgent)
...
- Phase 1.3 (Derived Insights + MenuBar UI): real `timeInApp` SQL (moat) + Swift Chart bar chart в menu-bar popover. ~2 дня.

## Следующим (Phase 1.4 → 1.5 → demo)
