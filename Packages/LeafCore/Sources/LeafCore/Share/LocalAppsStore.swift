...
/// Same `@unchecked Sendable` pattern as BrowserBookmarksFeatureGate above —
/// protocol's `get async` is satisfied by synchronous computed properties
/// (compiler synthesises the async wrapper).
