...
public struct GitHubProjectV2ItemSnapshot: Sendable, Hashable, Codable {
    ...
    public init(
        itemID: String, projectID: String, title: String, status: String?, iterationID: String?,
        fieldValues: [String: String], updatedAtMs: Int64
    ) {
        self.itemID = itemID
...
public struct GitHubRepoInvitationSnapshot: Sendable, Hashable, Codable {
    ...
    public init(invitationID: String, repoFullName: String, inviterLogin: String, invitedAtMs: Int64) {
        ...
        self.inviterLogin = inviterLogin
        self.invitedAtMs = invitedAtMs
    }
}
...
public struct GitHubSecurityAlertSnapshot: Sendable, Hashable {
    ...
    public let updatedAtMs: Int64
    public init(
        kind: Kind, repoFullName: String, alertNumber: Int, severity: String, rule: String, packageName: String?,
        state: String, createdAtMs: Int64, updatedAtMs: Int64
    ) {
        self.kind = kind
        self.repoFullName = repoFullName
