...
extension SupabaseClient {
    ...
    public func fetchInboundTeamEvents(
        ...
        let (data, response) = try await teamEventsTransport(request, label: "fetchInboundTeamEvents")
    ...
    private func teamEventsTransport(_ request: URLRequest, label: String) async throws -> (Data, HTTPURLResponse) {
