// Packages/LeafCore/Sources/LeafCore/OS/ChromeActiveStateMachine.swift
import Foundation

/// Phase Track-6 P3 — front-window active-tab diff for Chrome. See spec §7.3.
public struct ChromeActiveStateMachine: Sendable {
