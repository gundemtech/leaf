// Phase Track-6 P2 (Xcode Deep), P3 (Browsers Deep), P6 (IDEs surface cap)
// — ActivityFeedMapper rendering. Split from ActivityFeedMapperLocalOSTests.swift
...
final class ActivityFeedMapperLocalOSTrack6Tests: XCTestCase {
