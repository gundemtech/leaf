...
final class SupabaseClientFetchCrossPostLogTests: XCTestCase {
    ...
    func testFetchCrossPostLog_EmptyInput_ReturnsEmpty_NoNetwork() async throws {
        ...
        MockURLProtocol.handler = { _, _ in
            ...
            return (HTTPURLResponse(url: URL(string: "https://unused")!, statusCode: 500, httpVersion: nil, headerFields: nil)!,
                    Data())
        }
        ...
        MockURLProtocol.handler = { request, _ in
            ...
            case "/auth/v1/token":
                return (HTTPURLResponse(url: request.url!, statusCode: 200, httpVersion: nil, headerFields: nil)!,
                        ...
                        """.data(using: .utf8)!)
            default:
                return (HTTPURLResponse(url: request.url!, statusCode: 200, httpVersion: nil, headerFields: nil)!, badJSON)
            }
        }
        let client = makeClient()
        do {
