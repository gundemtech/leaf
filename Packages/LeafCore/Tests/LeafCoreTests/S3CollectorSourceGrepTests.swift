...
final class S3CollectorSourceGrepTests: XCTestCase {
    ...
    func testClipboardCollectorReadsNoPasteboardContent() throws {
        try grepForbiddenList(
            "LeafAgent/Collectors/ClipboardCollector.swift",
            [
                "pasteboardItems",
                "string(forType:",
                "data(forType:",
    ...
    func testMicInUseCollectorReadsNoAudioSamples() throws {
        try grepForbiddenList(
            "LeafAgent/Collectors/MicInUseCollector.swift",
            [
                "AVCaptureDevice",
                "AVCaptureSession",
                "AVAudioRecorder",
    ...
    func testAudioRouteCollectorReadsNoDeviceName() throws {
        try grepForbiddenList(
            "LeafAgent/Collectors/AudioRouteCollector.swift",
            [
    ...
    func testWiFiCollectorReadsNoSSID() throws {
        try grepForbiddenList(
            "LeafAgent/Collectors/WiFiCollector.swift",
            [
                ".ssid()",
                ".bssid()",
    ...
    func testDisplayCollectorReadsNoPixels() throws {
        try grepForbiddenList(
            "LeafAgent/Collectors/DisplayCollector.swift",
            [
    ...
    func testLocalFilesWatcherReadsNoFileContents() throws {
        try grepForbiddenList(
            "LeafAgent/Collectors/LocalFilesWatcher.swift",
            [
                "Data(contentsOf:",
                "String(contentsOf:",
    ...
    func testVPNCollectorReadsNoCredentials() throws {
        try grepForbiddenList(
            "LeafAgent/Collectors/VPNCollector.swift",
            [
                "serverAddress",
                "passwordReference",
    ...
    func testCGEventTapCollectorReadsNoEventContent() throws {
        try grepForbiddenList(
            "LeafAgent/Collectors/CGEventTapCollector.swift",
            [
