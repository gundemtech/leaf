// Packages/LeafCore/Tests/LeafCoreTests/SafariActiveStateMachineTests.swift
import XCTest
@testable import LeafCore

final class SafariActiveStateMachineTests: XCTestCase {
    func testColdTickNoEmit() {
        var sm = SafariActiveStateMachine()
    ...
    func testNoWindowIDNoEmit() {
        ...
        XCTAssertEqual(e.count, 0, "no window — Safari closed mid-tick")
    }
}
