...
struct LeafBannerPreview: View {
    var body: some View {
        VStack(alignment: .leading, spacing: LeafSpace.md) {
            ...
            TokensInlineSpec(
                spec:
                    "LeafBanner · raised surface + LeafIconChip md tone-tinted leading + LeafColor.border.subtle hairline · primary CTA sm + ghost dismiss md · info/success/warning/danger",
