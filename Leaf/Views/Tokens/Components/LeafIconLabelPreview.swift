...
struct LeafIconLabelPreview: View {
    var body: some View {
        VStack(alignment: .leading, spacing: LeafSpace.md) {
            ...
            TokensInlineSpec(
                spec:
                    "LeafIconLabel · icon (asset|system) + title · leading / centered / trailing · LeafIcon md + LeafType.body.regular",
                codeSnippet:
                    "LeafIconLabel(icon: .asset(LeafIcons.brand.leafFill), title: \"Active\", alignment: .leading)"
            )
        }
