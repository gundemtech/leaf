...
// IV.A.1 — Preview disabled; init shapes diverge from integration's Track-9 substrate
// (bundleID / sessionStartedAtMs / lastAppBundleID not in integration's YouNow types).
// Re-enable in IV.A.2 alongside full enrichment.
